...
router.get(
  "/students",
  authorize("admin"),
  memberController.getAllStudentsForAdmin,
);
...
router.get(
  "/mentor/my-batch",
  authorize("mentor"),
  memberController.getMembersForMentor,
);
router.get(
  "/mentor/student/:studentUserId",
  authorize("mentor"),
  memberController.getStudentDetailForMentor,
);
...
router.get(
  "/student/my-batch",
  authorize("student"),
  memberController.getMembersForStudent,
);
